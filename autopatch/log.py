...
class Log:
    ...
    def conclude():
        ...
        if len(Log.REJECT_LIST) > 0:
            ...
            Log.i("  |         - compare VENDOR and REJECT to find out where conflicts happened;                   ")
            Log.i("  |         - compare AOSP   and BOSP   to find out where Baidu changes;                        ")
            Log.i("  |         - compare VENDOR and BOSP   to decide how to resolve conflicts.                     ")
            Log.i("  |                                                                                             ")
        else:
            Log.i("  |                                                                                             ")
